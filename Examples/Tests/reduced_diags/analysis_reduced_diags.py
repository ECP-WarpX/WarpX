...
values_yt['Ex(0.5, 0.5, 0.5)'] = Ex[24, 24, 24]
values_yt['Ey(0.5, 0.5, 0.5)'] = Ey[24, 24, 24]
values_yt['Ez(0.5, 0.5, 0.5)'] = Ez[24, 24, 24]
values_yt['|E(0.5, 0.5, 0.5)|'] = np.sqrt(Ex[24, 24, 24]**2 + Ey[24, 24, 24]**2 + Ez[24, 24, 24]**2)
values_yt['Bx(0.5, 0.5, 0.5)'] = Bx[24, 24, 24]
values_yt['By(0.5, 0.5, 0.5)'] = By[24, 24, 24]
values_yt['Bz(0.5, 0.5, 0.5)'] = Bz[24, 24, 24]
values_yt['|B(0.5, 0.5, 0.5)|'] = np.sqrt(Bx[24, 24, 24]**2 + By[24, 24, 24]**2 + Bz[24, 24, 24]**2)
...
values_rd['Ex(0.5, 0.5, 0.5)'] = FPdata[1][2]
values_rd['Ey(0.5, 0.5, 0.5)'] = FPdata[1][3]
values_rd['Ez(0.5, 0.5, 0.5)'] = FPdata[1][4]
values_rd['|E(0.5, 0.5, 0.5)|'] = FPdata[1][5]
values_rd['Bx(0.5, 0.5, 0.5)'] = FPdata[1][6]
values_rd['By(0.5, 0.5, 0.5)'] = FPdata[1][7]
values_rd['Bz(0.5, 0.5, 0.5)'] = FPdata[1][8]
values_rd['|B(0.5, 0.5, 0.5)|'] = FPdata[1][9]
