...
values_yt['|E| at probe'] = np.sqrt(Ex[probe_pos]**2 + Ey[probe_pos]**2 + Ez[probe_pos]**2)
values_yt['Bx at probe'] = Bx[probe_pos]
values_yt['By at probe'] = By[probe_pos]
values_yt['Bz at probe'] = Bz[probe_pos]
values_yt['|B| at probe'] = np.sqrt(Bx[probe_pos]**2 + By[probe_pos]**2 + Bz[probe_pos]**2)
...
values_rd['|E| at probe'] = FPdata[1][5]
values_rd['Bx at probe'] = FPdata[1][6]
values_rd['By at probe'] = FPdata[1][7]
values_rd['Bz at probe'] = FPdata[1][8]
values_rd['|B| at probe'] = FPdata[1][9]
