...
ux0 = float(ds.parameters.get('electrons.multiple_particles_mom_x').split()[0])*c
uy0 = float(ds.parameters.get('electrons.multiple_particles_mom_y').split()[1])*c
uz0 = eval(ds.parameters.get('electrons.multiple_particles_mom_z').split()[0])*c
