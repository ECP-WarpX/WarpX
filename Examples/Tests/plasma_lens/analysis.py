...
ux0 = float(ds.parameters.get('electrons.multiplt_particle_ux').split()[0])*c
uy0 = float(ds.parameters.get('electrons.multiplt_particle_uy').split()[1])*c
uz0 = eval(ds.parameters.get('electrons.multiplt_particle_uz').split()[0])*c
