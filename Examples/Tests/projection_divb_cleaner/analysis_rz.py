...
ru = 1. + 0.5/(r_min*dri + ir + 0.5)
rd = 1. - 0.5/(r_min*dri + ir + 0.5)
...
dBrdr = (RU*grid0['raw', 'Bx_aux'].v[:,:,0,1] - RD*grid0['raw', 'Bx_aux'].v[:,:,0,0])*dri
dBzdz = (grid0['raw', 'Bz_aux'].v[:,:,0,1] - grid0['raw', 'Bz_aux'].v[:,:,0,0])*dzi
