...
A convergence study, starting from an input file similar to ./sim/inputs (with a different set of physical parameters generated by the APOSMM generator in a LibEnsemble run) is presented below.
