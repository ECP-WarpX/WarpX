...
* ``<species_name>.injection_style`` (`string`; default: ``none``)
    ...
    * ``MultipleParticles``: Inject multiple macroparticles.
      ...
      ``<species_name>.multiple_particles_mom_x`` (list of `doubles`, X normalized momenta of the particles, i.e. :math:`\gamma \beta_x`)
      ``<species_name>.multiple_particles_mom_y`` (list of `doubles`, Y normalized momenta of the particles, i.e. :math:`\gamma \beta_y`)
      ``<species_name>.multiple_particles_mom_z`` (list of `doubles`, Z normalized momenta of the particles, i.e. :math:`\gamma \beta_z`)
