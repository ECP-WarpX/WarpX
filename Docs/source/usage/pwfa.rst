...
For illustration purposes the setup can be explored with **WarpX** using the example input file :download:`PWFA <../../../Examples/plasma_acceleration/inputs_2d_boost>`.
