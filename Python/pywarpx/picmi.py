...
class ParticleListDistribution(picmistandard.PICMI_ParticleListDistribution):
    ...
    def initialize_inputs(self, species_number, layout, species, density_scale):
        ...
        species.multiplt_particle_ux = np.array(self.ux)/constants.c
        species.multiplt_particle_uy = np.array(self.uy)/constants.c
        species.multiplt_particle_uz = np.array(self.uz)/constants.c
