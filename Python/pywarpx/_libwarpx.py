...
class LibWarpX():
    ...
    def load_library(self):
        ...
        self.libwarpx_so.eval_expression_t.argtypes = [ctypes.c_char_p, c_real]
        self.libwarpx_so.warpx_calcSchottkyWeight.argtypes = [ctypes.c_char_p, c_real, ctypes.c_int]
