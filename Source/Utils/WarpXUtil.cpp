...
void CheckDims ()
{
    ...
    std::string dims_error = "ERROR: The selected WarpX executable was built with '";
    dims_error.append(dims_compiled).append("' geometry, but the ");
    dims_error.append("inputs file declares '").append(dims).append("' geometry.\n");
