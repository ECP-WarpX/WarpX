...
{
    WX_PROFILE("Laser::Evolve()");
    WX_PROFILE_VAR_NS("Laser::Evolve::Copy", blp_copy);
    WX_PROFILE_VAR_NS("Laser::ParticlePush", blp_pp);
    WX_PROFILE_VAR_NS("Laser::CurrentDepo", blp_cd);
    WX_PROFILE_VAR_NS("Laser::Evolve::Accumulate", blp_accumulate);
