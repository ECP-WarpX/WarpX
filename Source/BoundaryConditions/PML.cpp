...
PML::PML (const int lev, const BoxArray& grid_ba, const DistributionMapping& grid_dm,
          ...
          const bool do_multi_J, const int J_in_time, const int rho_in_time,
      ...
      m_cgeom(cgeom)
{
    ...
    if (WarpX::maxwell_solver_id == MaxwellSolverAlgo::PSATD) {
        ...
        amrex::ignore_unused(lev, dt, do_multi_J, J_in_time, rho_in_time);
#   if(AMREX_SPACEDIM!=3)
...
#   endif
        ...
        spectral_solver_fp = std::make_unique<SpectralSolver>(lev, realspace_ba, dm,
            ...
            fft_do_time_averaging, do_multi_J, J_in_time, rho_in_time, m_dive_cleaning, m_divb_cleaning);
#endif
    }
