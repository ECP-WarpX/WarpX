      ...
      m_geom(geom)
{
    ...
    WarpX::AllocInitMultiFab(pml_E_fp[0], amrex::convert( grid_ba, Er_fp.ixType().toIntVect() ), grid_dm,
                             Er_fp.nComp(), Er_fp.nGrowVect(), "pml_E_fp[0]", 0.0_rt);
    WarpX::AllocInitMultiFab(pml_E_fp[1], amrex::convert( grid_ba, Et_fp.ixType().toIntVect() ), grid_dm,
                             Et_fp.nComp(), Et_fp.nGrowVect(), "pml_E_fp[1]", 0.0_rt);
    ...
    WarpX::AllocInitMultiFab(pml_B_fp[0], amrex::convert( grid_ba, Br_fp.ixType().toIntVect() ), grid_dm,
                             Br_fp.nComp(), Br_fp.nGrowVect(), "pml_B_fp[0]", 0.0_rt);
    WarpX::AllocInitMultiFab(pml_B_fp[1], amrex::convert( grid_ba, Bt_fp.ixType().toIntVect() ), grid_dm,
                             Bt_fp.nComp(), Bt_fp.nGrowVect(), "pml_B_fp[1]", 0.0_rt);
