...
#elif defined(WARPX_DIM_RCYLINDER) || defined(WARPX_DIM_RSPHERE)
    amrex::MultiFab tmp_U_minus_x( amrex::convert(ba, IntVect(0)), N[lev]->DistributionMap(), 4, 1);
    amrex::MultiFab tmp_U_plus_x( amrex::convert(ba, IntVect(0)), N[lev]->DistributionMap(), 4, 1);
#endif
