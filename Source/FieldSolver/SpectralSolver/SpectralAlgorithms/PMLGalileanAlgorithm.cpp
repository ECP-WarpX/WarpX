...
PMLGalileanAlgorithm::PMLGalileanAlgorithm(
 ...
 * over one time step */
void
PMLGalileanAlgorithm::pushSpectralFields(SpectralFieldData& f) const{
...
void PMLGalileanAlgorithm::InitializeSpectralCoefficients (
    const SpectralKSpace& spectral_kspace,
