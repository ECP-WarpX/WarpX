...
WarpX::EvolveB (int lev, PatchType patch_type, amrex::Real a_dt)
{
    ...
    if (patch_type == PatchType::fine) {
        m_fdtd_solver_fp[lev]->EvolveB( Bfield_fp[lev], Efield_fp[lev], face_areas[lev], lev, a_dt );
    } else {
        m_fdtd_solver_cp[lev]->EvolveB( Bfield_cp[lev], Efield_cp[lev], face_areas[lev], lev, a_dt );
    }
...
WarpX::EvolveE (int lev, PatchType patch_type, amrex::Real a_dt)
{
    ...
    if (patch_type == PatchType::fine) {
        m_fdtd_solver_fp[lev]->EvolveE( Efield_fp[lev], Bfield_fp[lev],
                    current_fp[lev], edge_lengths[lev], F_fp[lev], lev, a_dt );
    } else {
        m_fdtd_solver_cp[lev]->EvolveE( Efield_cp[lev], Bfield_cp[lev],
                    current_cp[lev], edge_lengths[lev], F_cp[lev], lev, a_dt );
    }
