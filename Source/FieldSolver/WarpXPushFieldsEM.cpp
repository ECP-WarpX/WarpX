...
namespace {
    ...
    PushPSATDSinglePatch (
        ...
        {
            solver.ForwardTransform(lev, *current[0], TwoIdx::Jx_2, 1);
            solver.ForwardTransform(lev, *current[1], TwoIdx::Jy_2, 1);
            solver.ForwardTransform(lev, *current[2], TwoIdx::Jz_2, 1);
            solver.ForwardTransform(lev, *rho, TwoIdx::rho_old_2, 2);
            solver.ForwardTransform(lev, *rho, TwoIdx::rho_new_2, 3);
        }
