...
subroutine warpx_charge_deposition(rho,np,xp,yp,zp,w,q,xmin,ymin,zmin,dx,dy,dz,nx,ny,nz,&
  ...
  subroutine warpx_current_deposition( &
    ...
    np,xp,yp,zp,uxp,uyp,uzp,vx_gal,vy_hal,vz_gal, gaminv,w,q,xmin,ymin,zmin,dt,dx,dy,dz,nox,noy,noz,&
    ...
    real(amrex_real), intent(IN),  dimension(np)                     :: vx_gal,vy_hal,vz_gal
...
! Dimension 2
        ...
        jy,jy_nguards,jy_nvalid,            &
        jz,jz_nguards,jz_nvalid,            &
        np,xp,yp,zp,uxp,uyp,uzp,vx_gal,vy_hal,vz_gal, gaminv,w,q, &
