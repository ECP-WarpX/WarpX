...
Resampling::Resampling (std::string& species_name)
{
    ...
    else if (resampling_algorithm_string == "grid_based")
    {
        m_resampling_algorithm = std::make_unique<GridBasedMerging>(species_name);
    }
    else
