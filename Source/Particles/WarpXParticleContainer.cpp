                                       ...
                                       Real dt)
{
    ...
    WX_PROFILE_VAR_NS("PPC::Evolve::Accumulate", blp_accumulate);
    WX_PROFILE_VAR_NS("PPC::CurrentDeposition", blp_deposit);
    ...
    WX_PROFILE_VAR_START(blp_deposit);
    if (WarpX::current_deposition_algo == CurrentDepositionAlgo::Esirkepov) {
        if        (WarpX::nox == 1){
    ...
    WX_PROFILE_VAR_STOP(blp_deposit);

#ifndef AMREX_USE_GPU
    WX_PROFILE_VAR_START(blp_accumulate);
    ...
    WX_PROFILE_VAR_STOP(blp_accumulate);
#endif
}
                                       ...
                                       int thread_num, int lev, int depos_lev)
{
    ...
    WX_PROFILE_VAR_NS("PPC::ChargeDeposition", blp_ppc_chd);
    WX_PROFILE_VAR_NS("PPC::Evolve::Accumulate", blp_accumulate);
    ...
    WX_PROFILE_VAR_START(blp_ppc_chd);
    if        (WarpX::nox == 1){
    ...
    WX_PROFILE_VAR_STOP(blp_ppc_chd);
