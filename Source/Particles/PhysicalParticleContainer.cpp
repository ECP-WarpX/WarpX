                                  ...
                                  Real dt)
{
    ...
    if (WarpX::do_boosted_frame_diagnostic && do_boosted_frame_diags)
    {
        // This function stores the values of xp,yp and zp in the xpold,ypold and zpold
    ...
    // The commands below will be moved to the future cpp version of warpx_particle_pusher
    auto& attribs = pti.GetAttribs();
    auto& uxp = attribs[PIdx::ux];
    auto& uyp = attribs[PIdx::uy];
    auto& uzp = attribs[PIdx::uz];
...
void
PhysicalParticleContainer::warpx_copy_attribs(WarpXParIter& pti, const amrex::Real* xp,
