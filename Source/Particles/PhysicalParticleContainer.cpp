...
int
PhysicalParticleContainer::doFieldIonization(
    const int lev, 
    Cuda::ManagedDeviceVector<Real>& x_buf,
    Cuda::ManagedDeviceVector<Real>& y_buf,
    Cuda::ManagedDeviceVector<Real>& z_buf,
