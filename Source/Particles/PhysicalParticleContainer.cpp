...
PhysicalParticleContainer::InitIonizationModule ()
{
    ...
    queryWithParser(pp_species_name, "do_adk_correction", do_adk_correction);
    ...
    Real const * const AMREX_RESTRICT p_adk_correction_factors = adk_correction_factors.data();
    Gpu::synchronize();
}
