    ...
    const bool plot_raw_fields_guards) const
{
    ...
    for (int lev = 0; lev < nlevels; ++lev)
    {
        ...
        WriteRawMF( *warpx.m_fields.get("Bfield_XX", Direction{0}, lev), dm, raw_pltname,
                    default_level_prefix, "Bx_fp", lev, plot_raw_fields_guards );
        WriteRawMF( *warpx.m_fields.get("Bfield_XX", Direction{1}, lev), dm, raw_pltname,
                    default_level_prefix, "By_fp", lev, plot_raw_fields_guards );
        WriteRawMF( *warpx.m_fields.get("Bfield_XX", Direction{2}, lev), dm, raw_pltname,
        ...
        if (lev > 0) {
            ...
            WriteCoarseVector( "B",
                               ...
                               warpx.m_fields.get("Bfield_XX", Direction{0}, lev),
                               warpx.m_fields.get("Bfield_XX", Direction{1}, lev),
                               warpx.m_fields.get("Bfield_XX", Direction{2}, lev),
                               dm, raw_pltname, default_level_prefix, lev, plot_raw_fields_guards);
            WriteCoarseVector( "j",
