        ...
        bool /*isLastBTDFlush*/) const
{
    ...
    for (int lev = 0; lev < nlev; ++lev)
    {
        ...
        VisMF::Write(*warpx.m_fields.get("Bfield_XX", Direction{0}, lev),
                     amrex::MultiFabFileFullPrefix(lev, checkpointname, default_level_prefix, "Bx_fp"));
        VisMF::Write(*warpx.m_fields.get("Bfield_XX", Direction{1}, lev),
                     amrex::MultiFabFileFullPrefix(lev, checkpointname, default_level_prefix, "By_fp"));
        VisMF::Write(*warpx.m_fields.get("Bfield_XX", Direction{2}, lev),
