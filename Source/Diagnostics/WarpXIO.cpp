...
{
    WX_PROFILE("WarpX::WriteCheckPointFile()");
...
{
    WX_PROFILE("WarpX::InitFromCheckpoint()");
...
WarpX::GetCellCenteredData() {
    ...
    WX_PROFILE("WarpX::GetCellCenteredData");
...
{
    WX_PROFILE("WarpX::WriteOpenPMDFile()");
...
{
    WX_PROFILE("WarpX::WritePlotFile()");
