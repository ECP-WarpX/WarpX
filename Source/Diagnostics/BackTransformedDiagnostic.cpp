...
namespace
{
    ...
    */
    ...
    {
        WX_PROFILE("output_write_metadata");
    ...
    */
    ...
    {
        WX_PROFILE("output_create_field");
    ...
    */
    ...
    {
        WX_PROFILE("output_resize_particle_field");
    ...
    */
    ...
    {
        WX_PROFILE("output_write_particle_field");
    ...
    */
    ...
    {
        WX_PROFILE("output_create_particle_field");
      ...
      m_particle_slice_width_lab_(particle_slice_width_lab)
{
    ...
    WX_PROFILE("BackTransformedDiagnostic::BackTransformedDiagnostic");
...
{
    WX_PROFILE("BackTransformedDiagnostic::Flush");
...
writeLabFrameData(const MultiFab* cell_centered_data,
    ...
    WX_PROFILE("BackTransformedDiagnostic::writeLabFrameData");
    VisMF::Header::Version current_version = VisMF::GetHeaderVersion();
    VisMF::SetHeaderVersion(amrex::VisMF::Header::NoFabHeader_v1);
...
{
    WX_PROFILE("BackTransformedDiagnostic::writeParticleData");
...
writeMetaData ()
{
    WX_PROFILE("BackTransformedDiagnostic::writeMetaData");
